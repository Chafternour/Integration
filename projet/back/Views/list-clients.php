                        ...
                        <div class="product-status-wrap">
                            ...
                            <button onclick="printData()">Imprimer</button>
                                ...
                                <tr>
                                    ...
                                    <th onclick="sortTable(3)">sexe</th>
                                    <th onclick="sortTable(4)">Date de Naissance</th>
                                    <th onclick="sortTable(5)">Adresse Mail</th>
                                    <th onclick="sortTable(6)">Adresse</th>
                                    <th onclick="sortTable(7)">Numero</th>
                                    <th onclick="sortTable(8)">Mot de passe</th>
                                    <th onclick="sortTable(9)">Point de fidélité</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['mot_d_p']; ?> </td>
                                    <td><?php echo $row['points_f']; ?> </td>
                                    <td><?php echo $row['grad_fk']; ?> </td>
                                    
                                    
                                     <td><a href="client-edit.php?ref=<?php echo $row['cin']; ?>">Modifier</a></td> 
                                      <td>  
                                      <td>  
