...
session_start();
if(!isset($_SESSION['l']))
header('location:../../front/views/authentification.html');
?>
...
<head>
    ...
    <title>Modifier Client| Kalthita</title>
...
<body>
    <?PHP
          ...
          include "../core/clientC.php";
            ...
            $clientC=new clientC();
              $result=$clientC->recupererClient($_GET['ref']);
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="list-clients.php ?>"><i class="fa fa-list sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des clients</span></a></li>
                                 <li><a title="Client Edit" href="client-edit.php"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Editer un client</span></a></li>
                                  <li><a title="Client Stat" href="stat-client.php"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Statistiques des clientsnot</span></a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="single-product-tab-area mg-tb-15">
            ...
            <div class="single-pro-review-area">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Modifier Client</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $cin ?>" name="cin" type="number" class="form-control" placeholder="cin" disabled>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $nom ?>" name="nom" type="text" class="form-control" placeholder="Nom client" disabled>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $prenom ?>" name="prenom" type="text" class="form-control" placeholder="prenom" disabled>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $sexe ?>" name="qt" type="text" class="form-control" placeholder="Sexe" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $date_n ?>" name="date_n" type="text" class="form-control" placeholder="Date de naissance" Disabled>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $adresse_m ?>" name="adresse_m" type="Mail" class="form-control" placeholder="adresse mail" Disabled>
                                                    </div>

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $adresse ?>" name="adresse" type="text" class="form-control" placeholder="adresse postale" disabled>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $numero ?>" name="numero" type="number" class="form-control" placeholder="numero" disabled>
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-qrcode" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $mot_d_p ?>" name="mot_d_p" type="text" class="form-control" placeholder="Mot de passe" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-ticket" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $points_f ?>" name="points_f" type="number" class="form-control" placeholder="points_f" >
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $grad_fk ?>" name="grad_fk" type="text" class="form-control" placeholder=" grad_fk" >
                                                    </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <button name="modifier" type="submit" class="btn btn-primary waves-effect waves-light m-r-10">Modifier
                                                        ...
                                                        <input type="hidden" name="cin" value="<?php echo $_GET['ref'] ?>">
                ...
                if (isset($_POST['modifier']))
                     {
                  $client=new client("","","","","","","","","",$_POST['points_f'],$_POST['grad_fk']);
