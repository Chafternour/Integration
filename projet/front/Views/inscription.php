...
<body>
	...
	<!-- connexion section -->
		...
		<form  method="POST" name="form" class="inscription-form" action="add-client.php" enctype="multipart/form-data" onsubmit="return inscription()">
		               <td> CIN </td>
	                   <input type="number" name="cin" placeholder="Ton numéro de CIN" >
	                   <td>NOM</td>
						...
						<td>MOT DE PASSE</td>
						<input type="Password" name="mot_d_p" placeholder="Ton mot de passe">
						<td>GRADE</td> <br>
						<input type="radio" name="grad_fk" value="Basic" checked> Basic
					
						<br><br> <button type="submit" class="site-btn">SIGN UP</button>
					</form>
				</div>
			</div>
		</div>
